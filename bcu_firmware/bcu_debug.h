...
void debug_status_text(){
  ...
  strcpy_P(disp_buffer, (char *)pgm_read_ptr(dbg_string_0));
  display.drawString(0, 2, disp_buffer);
  strcpy_P(disp_buffer, (char *)pgm_read_ptr(dbg_string_1));
...
void debug_debug_text(){
  display.setFont(FONT_BOLD);
  strcpy_P(disp_buffer, (char *)pgm_read_ptr(dbg_string_2));
